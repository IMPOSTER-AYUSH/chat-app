...
useEffect(()=>{
  ...
  return (
    selectedUser && (
      ...
      >
        <div className="pt-16 flex flex-col items-center gap-4 text-xs font-light mx-auto text-center">
          ...
          {/* Online Dot + Name (on one line, centered) */}
          ...
          {/* Bio */}
          <p className="px-6 text-sm text-gray-300">{selectedUser.bio}</p>
        </div>
...
//       <h1 className='px-20 text-xl font-medium mx-auto flex items-center gap-2'>
